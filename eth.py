# Python script to transfer ETH with pros balance and static gas

# infura apikey
rpc_url = 'https://goerli.infura.io/v3/e3a353ba9d1b4c4299512af80277f4e5'
...
print(f'https://goerli.etherscan.io/tx/{web3.to_hex(tx_hash)}')